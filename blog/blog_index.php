    ...
    <main class="max-w-7xl mx-auto px-4 py-12">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-white p-4 rounded-lg shadow text-center cursor-pointer hover:shadow-lg transition-shadow">
                    <img src="/api/placeholder/60/60" alt="Car Reviews" class="mx-auto mb-2">
                    <h3 class="font-semibold">Car Reviews</h3>
                </div>
                <div class="bg-white p-4 rounded-lg shadow text-center cursor-pointer hover:shadow-lg transition-shadow">
                    <img src="/api/placeholder/60/60" alt="Travel Stories" class="mx-auto mb-2">
                    <h3 class="font-semibold">Travel Stories</h3>
                </div>
                <div class="bg-white p-4 rounded-lg shadow text-center cursor-pointer hover:shadow-lg transition-shadow">
                    <img src="/api/placeholder/60/60" alt="Maintenance Tips" class="mx-auto mb-2">
                    <h3 class="font-semibold">Maintenance Tips</h3>
                </div>
                <div class="bg-white p-4 rounded-lg shadow text-center cursor-pointer hover:shadow-lg transition-shadow">
                    <img src="/api/placeholder/60/60" alt="Driving Guide" class="mx-auto mb-2">
                    <h3 class="font-semibold">Driving Guide</h3>
                </div>
            </div>
        </div>
